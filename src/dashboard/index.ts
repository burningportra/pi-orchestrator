...
export { renderDashboardLines, renderPhaseHeader, renderProgressBar, renderGoalLine, renderBeadTable, renderStaleFooterNote, renderTenderSection, renderAlerts } from "./render.js";
